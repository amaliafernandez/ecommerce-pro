...
function Button({label, active}) {
    return (
        <button
            type="button"
            className={`rounded-xl px-6 py-3 text-base font-medium border transition-colors ${
                active
                      ...
                      {usuario.nombre}
                                    ...
                                    <div className="flex justify-end">
                                        <button
                                            ...
                                            disabled={esAdmin}
                                            title={
                                                esAdmin? "Los usuarios Admin no se pueden eliminar" : "Eliminar usuario"
                                            }
                                            className={`flex h-9 w-9 items-center justify-center rounded-lg transition-colors ${
                                                esAdmin? "text-slate-600 cursor-not-allowed" : "text-red-400 hover:bg-red-500/10"}`}>
                                            {esAdmin ? (
