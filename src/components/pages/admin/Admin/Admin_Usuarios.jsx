import { Settings, User, Search, Trash2, Lock } from "lucide-react";
            ...
            <div className="mx-auto max-w-6xl px-6 py-8">
                <header className="flex items-center justify-between border-b border-white/10 pb-6">
                    <div className="flex items-center gap-3">
                        <Settings className="h-7 w-7 text-indigo-400" strokeWidth={1.8} />
                ...
                <div className="mt-10 flex flex-wrap items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="rounded-full border border-white/10 bg-white/[0.03] px-4 py-1 text-sm text-slate-400">
              {usuarios.length} en total
                ...
                <div className="mt-6 overflow-hidden rounded-2xl border border-white/10 bg-white/[0.015]">
                    <div className="grid grid-cols-[2fr_2fr_1fr_0.5fr] gap-4 border-b border-white/10 px-6 py-4 text-xs font-medium uppercase tracking-wider text-slate-500">
                        <span>Nombre</span>
                        <span>Email</span>
                        <span>Rol</span>
